...
Use `quest-state` first. Improvement records concrete process learning and proposes follow-up edits; it does not directly modify skills or methodology files.

1. Read `quest.md`, `knowledge/index.md`, relevant knowledge artifacts, `summary.md`, and task briefs.
...
6. Write `## Improvement` in `quest.md` with observations, recommendations, and a small implementation plan.
